...
<html lang="en">
<head>
  <title>Code coverage report for lib/config/load.js</title>
  <meta charset="utf-8">
...
<div class="header high">
  <h1>Code coverage report for <span class="entity">lib/config/load.js</span></h1>

  <h2>

    Statements: <span class="metric">84.21% <small>(48 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    Lines: <span class="metric">84.21% <small>(48 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;

  </h2>
  <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/config/</a> &#187; load.js
  </div>
</div>
<div class="body">
...
&nbsp;
        ...
        return legacy('.nodemonignore', <span class="fstat-no" title="function not covered">function () {</span>
<span class="cstat-no" title="statement not covered">          legacy('nodemon-ignore', <span class="fstat-no"
                                                                                              title="function not covered">function (options) {</span></span>
<span class="cstat-no" title="statement not covered">            ready(options);</span>
          });
        });
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered">      fail(options);</span>
    } else {
<span class="cstat-no" title="statement not covered">      success(options);</span>
    }
  });
}
&nbsp;
...
function loadFile(options, config, dir, ready) {
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (!ready) {
<span class="cstat-no" title="statement not covered">    ready = <span class="fstat-no" title="function not covered">function () {</span>};</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered">      utils.log.fail('Failed to parse config ' + filename);</span>
    }
&nbsp;
