...
<html lang="en">
<head>
  <title>Code coverage report for lib/rules/add.js</title>
  <meta charset="utf-8">
...
<div class="header high">
  <h1>Code coverage report for <span class="entity">lib/rules/add.js</span></h1>
  ...
  <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/rules/</a> &#187; add.js
  </div>
</div>
<div class="body">
...
function add(rules, which, rule) {
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (!{ 'ignore' : 1, 'watch' : 1}[which]) {
<span class="cstat-no" title="statement not covered">    throw new Error('rules/index.js#add requires "ignore" or "watch" as the first argument');</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (rule instanceof RegExp) {
    // rule = ':' + rule.toString().replace(/^\/(.*?)\/$/g, '$1');
<span class="cstat-no" title="statement not covered">    utils.log.error('RegExp format no longer supported, but globs are.');</span>
