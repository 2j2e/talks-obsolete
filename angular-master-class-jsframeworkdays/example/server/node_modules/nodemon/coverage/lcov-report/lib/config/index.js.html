...
<html lang="en">
<head>
  <title>Code coverage report for lib/config/index.js</title>
  <meta charset="utf-8">
...
<div class="header high">
  <h1>Code coverage report for <span class="entity">lib/config/index.js</span></h1>
  ...
  <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/config/</a> &#187; index.js
  </div>
</div>
<div class="body">
...
&nbsp;
    var cwd = process.cwd();
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (config.dirs.length === 0) {
      config.dirs.unshift(cwd);
    }
&nbsp;
    // now run automatic checks on system adding to the config object
    checkWatchSupport(config, function (config) {
      <span class="missing-if-branch" title="if path not taken"" >I</span>if (config.system.useFind === false &amp;&amp; <span
    class="branch-1 cbranch-no" title="branch not covered">config.system.useWatch === false)</span> {
<span class="cstat-no" title="statement not covered">        config.system.useWatchFile = true;</span>
      }
