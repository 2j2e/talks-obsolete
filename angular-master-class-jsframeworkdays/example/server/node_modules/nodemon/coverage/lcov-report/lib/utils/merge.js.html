...
<html lang="en">
<head>
  <title>Code coverage report for lib/utils/merge.js</title>
  <meta charset="utf-8">
...
<div class="header high">
  <h1>Code coverage report for <span class="entity">lib/utils/merge.js</span></h1>
  ...
  <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/utils/</a> &#187; merge.js
  </div>
</div>
<div class="body">
<pre><table class="coverage">
  <tr>
    ...
    <td class="text"><pre class="prettyprint lang-js">var clone = require('./clone');
&nbsp;
...
function merge(source, target, result) {
  <span class="missing-if-branch" title="else path not taken"" >E</span>if (result === undefined) result = clone(source);
&nbsp;
...
<span class="cstat-no" title="statement not covered">        result[key] = target[key];</span>
      }
&nbsp;
