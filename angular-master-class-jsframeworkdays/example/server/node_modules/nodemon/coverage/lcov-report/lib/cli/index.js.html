...
<html lang="en">
<head>
  <title>Code coverage report for lib/cli/index.js</title>
  <meta charset="utf-8">
...
<div class="header high">
  <h1>Code coverage report for <span class="entity">lib/cli/index.js</span></h1>
  ...
  <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/cli/</a> &#187; index.js
  </div>
</div>
<div class="body">
<pre><table class="coverage">
  <tr>
    ...
    <td class="text"><pre class="prettyprint lang-js">var parse = require('./parse');
&nbsp;
/**
...
&nbsp;
    ...
    // parsed.options.exec = parsed.exec;
    // parsed.options.ext = parsed.ext;
&nbsp;
