...
<html lang="en">
<head>
  <title>Code coverage report for lib/config/exec.js</title>
  <meta charset="utf-8">
...
<div class="header high">
  <h1>Code coverage report for <span class="entity">lib/config/exec.js</span></h1>

  <h2>

    Statements: <span class="metric">85.42% <small>(41 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;


    Branches: <span class="metric">78.33% <small>(47 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;


    Functions: <span class="metric">100% <small>(3 / 3)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;


    Lines: <span class="metric">85.42% <small>(41 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;

  </h2>
  <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/config/</a> &#187; exec.js
  </div>
</div>
<div class="body">
...
&nbsp;
  var options = utils.clone(nodemonOptions || <span class="branch-1 cbranch-no" title="branch not covered">{})</span>,
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (extension.indexOf('.') === 0) {
<span class="cstat-no" title="statement not covered">    extension = extension.slice(1);</span>
  }
&nbsp;
...
&nbsp;
  if (options.exec === undefined) {
    ...
    options.exec = (options.exec || <span class="branch-1 cbranch-no" title="branch not covered">'')</span>.replace(/\{\{(filename|pwd)\}\}/, function (all, m) {
      <span class="missing-if-branch" title="else path not taken"" >E</span>if (m === 'filename') {
        return script || <span class="branch-1 cbranch-no" title="branch not covered">'';</span>
      } else <span class="cstat-no" title="statement not covered">if (m === 'pwd') {</span>
...
&nbsp;
  ...
  if (!execDefined &amp;&amp; options.exec === 'node' &amp;&amp; scriptExt.indexOf('coffee') !== -1) {
    ...
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (options.execArgs === undefined) {
<span class="cstat-no" title="statement not covered">      options.execArgs = [];</span>
    }
&nbsp;
...
&nbsp;
  if (options.exec === 'coffee') {
    ...
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (!options.ext) {
      extension = 'coffee litcoffee js';
    }
&nbsp;
    // because windows can't find 'coffee', it needs the real file 'coffee.cmd'
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (utils.isWindows) {
<span class="cstat-no" title="statement not covered">      options.exec += '.cmd';</span>
    }
  }
&nbsp;
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken"" >I</span>if (nodemonOptions.env !== undefined) {
<span class="cstat-no" title="statement not covered">    throw new Error('nodemon env values must be an object: { PORT: 8000 }');</span>
  }
&nbsp;
  return options;
}</pre>
