...
<html lang="en">
<head>
  <title>Code coverage report for lib/config/watchable.js</title>
  <meta charset="utf-8">
...
<div class="header high">
  <h1>Code coverage report for <span class="entity">lib/config/watchable.js</span></h1>
...
<span class="cstat-no" title="statement not covered">    tmpdir = process.env.TEMP;</span>
  } else <span class="missing-if-branch" title="else path not taken"" >E</span>if (process.env.TMPDIR) {
    tmpdir = process.env.TMPDIR;
  } else {
<span class="cstat-no" title="statement not covered">    tmpdir = '/tmp';</span>
  }
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (watchFile &lt; 0) {
<span class="cstat-no" title="statement not covered">    utils.log.fail('Unable to write to temp directory. If you experience problems with file reloading, ensure ' + tmpdir + ' is writable.');</span>
