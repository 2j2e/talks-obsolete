...
vows.describe('log4js').addBatch({
  'getLogger': {
    ...
    'log events': {
      topic: function (logger) {
        var events = [];
        logger.addListener("log", function (logEvent) {
          ...
          { requires: { 'fs': { statSync: function () {
            ...
            readFileSync: function (filename) {
              ...
              return JSON.stringify({
                appenders: [
                  { type: "file", filename: "whatever.log"
                  }
                ]
              });
            },
  ...
  'configuration persistence': {
    topic: function () {
      ...
      firstLog4js.addAppender(function (evt) {
        logEvent = evt;
      });
