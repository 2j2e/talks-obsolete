...
Object.defineProperty(exports, "defaults", {get: function () {
  ...
  return defaults =
  { "always-auth": false, "bin-links": true, browser: null, ca: // the npm CA certificate.
    [ "-----BEGIN CERTIFICATE-----\n" +
    ...
    process.env.HTTP_PROXY || process.env.http_proxy || null, "user-agent": "node/" + process.version
    + ' ' + process.platform
    + ' ' + process.arch, "rebuild-bundle": true, registry: "https://registry.npmjs.org/", rollback: true, save: false, "save-bundle": false, "save-dev": false, "save-optional": false, searchopts: "", searchexclude: null, searchsort: "name", shell: osenv.shell(), "sign-git-tag": false, "strict-ssl": true, tag: "latest", tmp: temp, unicode: true, "unsafe-perm": process.platform === "win32"
