...
declare module ng {
  ...
  interface IAngularStatic {
     ...
     */
    module(/** name of your module you want to create */
           name:string, /** name of modules yours depends on */
           requires?:string[], configFunction?:any): IModule;
    noop(...args:any[]): void;
  ...
  interface IQService {
    ...
    all(promises:{[id: string]: IPromise<any>;
  ...
  interface ICacheFactoryService {
    ...
    (cacheId:string, optionsMap?:{ capacity: number;
    }): ICacheObject;
  ...
  interface IDirective {
    compile?:
      (templateElement:IAugmentedJQuery, templateAttributes:IAttributes, transclude:ITranscludeFunction) => any;
    controller?: any;
    controllerAs?: string;
    link?:
  ...
  interface IAugmentedJQuery extends JQuery {
    ...
    inheritedData(obj:{ [key: string]: any;
    }): JQuery;
